/**
 * Canvas search state and filter logic. GitHub #85 — search on canvas.
...
export function normalizeCanvasSearchState(
  ...
  return {
    ...
    searchFilterGroup:
      raw.searchFilterGroup === null || raw.searchFilterGroup === undefined
        ? null
        : String(raw.searchFilterGroup),
    searchFilterTag:
...
export function getVisibleGroupIds(
  ...
  if (normalized.searchFilterGroup !== null) {
    const gid = normalized.searchFilterGroup;
